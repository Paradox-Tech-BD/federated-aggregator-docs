    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT DESIGN GATE</span><h2>Design Core-mediated model streaming without locator or credential disclosure.</h2></div><p>The guarded descriptor-only intent now proved one generated Azure issuance and expiry with no storage access. Next, the ledger must define a node-only Core stream that validates a live intent and never gives the node an object address, bucket, provider credential, or presigned URL. No Agent download, training, update, submission, ML-worker identity, or hospital data is permitted until that design and proof exist.</p><CheckCircle2 size={24} /></section>
        </div>
