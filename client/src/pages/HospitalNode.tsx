    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT IMPLEMENTATION GATE</span><h2>Implement only the reviewed Core-mediated generated-fixture stream.</h2></div><p>The complete streaming dossier now fixes a node-only Core proxy, one full-body response, explicit integrity/closure state, and no locator or credential disclosure. Next, the implementation may create only the reviewed generated-fixture stream slice. No Agent download integration, local training, update, submission, ML-worker identity, hospital data, or aggregation worker activation is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
