...
export default function HospitalNode() {
  return (
    <div className="doc-page node-dossier">
      ...
      <section className="node-next"><div><span>NEXT IMPLEMENTATION GATE</span><h2>Implement the new Core workload authorization and schema path before any node-to-Core call.</h2></div><p>The Core contract is now documented. Its implementation must begin with separate `hospital_node` identity, assignment, lease, audit, and contract tests—never by reusing a human administrator or ML-worker route.</p><CheckCircle2 size={24} /></section>
    </div>
  );
}
