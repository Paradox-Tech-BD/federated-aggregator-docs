    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT IMPLEMENTATION GATE</span><h2>Issue a lease-bound descriptor-only base-model-read intent before any storage access.</h2></div><p>The Core now has a deployed private verified base-model descriptor registry with immutable digest, checksum, size, replay, and redaction boundaries. Next, the ledger permits a guarded node-only intent receipt bound to an active lease and canonical command. No URL, credential, locator, byte, download, storage call, training, update, submission, ML-worker identity, or hospital data is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
