    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT VALIDATION GATE</span><h2>Issue and expire one guarded descriptor-only intent without storage access.</h2></div><p>The Core now has a deployed node-only read-intent receipt bound to an active lease, canonical command, and immutable descriptor registry. Next, a separate one-shot profile must invoke it once with generated facts, prove redaction, then expire the intent/lease/assignment. No URL, credential, locator, byte, download, storage call, training, update, submission, ML-worker identity, or hospital data is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
