    ...
    <div className="doc-page node-dossier">
      ...
      <div className="node-ledger-layout">
        <div className="node-ledger-main">
          ...
          <section className="node-next"><div><span>NEXT DESIGN GATE</span><h2>Freeze Core-owned verified base-model descriptors before any read intent.</h2></div><p>Schema review confirms a round’s current base-model version is only an opaque string. Next, the ledger requires a private verified descriptor registry bound to an existing Core artifact, with immutable digest, checksum, size, replay, revocation, and redaction rules. No URL, credential, locator, byte, download, intent, training, update, submission, ML-worker identity, or hospital data is permitted.</p><CheckCircle2 size={24} /></section>
        </div>
