...
export default function ImplementationPlan() {
  return (
    <div className="doc-page implementation-page">
      ...
      <section className="implementation-handoff"><div><ClipboardList size={23} /><span>HANDOFF APPROVAL GATES</span><h2>Five decisions unlock repository creation.</h2></div><ol><li>Approve the core-only product boundary and explicit exclusions.</li><li>Approve the local human/membership/workload schema and OIDC/Clerk boundary.</li><li>Approve deferring MetaMask/SIWE until a distinct non-clinical requirement and security review exist.</li><li>Authorize a short persistence and Python-toolchain proof of concept before fixing adapters.</li><li>Authorize creation of private `paradox-tech-bd/federated-aggregator-core` and execution of Phases 0–1 only.</li></ol><CheckCircle2 size={31} /></section>
    </div>
  );
}
