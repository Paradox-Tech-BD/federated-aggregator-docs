...
- [ ] Increment F — Implement the documented creation-only profile, runner, and deterministic tests; do not execute it in Azure until its deployment passes and the default-disabled worker gate is verified.
